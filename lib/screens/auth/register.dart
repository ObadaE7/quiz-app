...
class _RegisterState extends State<Register> {
  ...
  Future<void> _register() async {
    if (widget._registerFormKey.currentState!.validate()) {
      ...
      if (usersMapData.containsKey(email)) {
        ...
        usersMapData[email] = [fullName, password];
        await prefs.setString('users', json.encode(usersMapData));
        _showSnackBar('تم التسجيل بنجاح', color: AppColors.green);
  ...
  void _showSnackBar(String message, {Color color = AppColors.charcoal}) {
